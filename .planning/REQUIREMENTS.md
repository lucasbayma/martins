...
- [ ] **SEL-04**: Selection highlight does not flicker or disappear when the underlying PTY buffer receives new output — the selection stays stable until the user clears it
